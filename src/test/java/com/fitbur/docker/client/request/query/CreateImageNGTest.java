...
import static com.fitbur.docker.client.model.ImageConfig.newBuilder;
 ...
 */
@HK2
public class CreateImageNGTest {
    ...
    public void testExecute() {
        ImageConfig.Builder builder = newBuilder()
                .setFromImage("busybox");

        List<ImageStatus> result = client.request(builder.build(), sut);
