 ...
 */
@Service
public class RestartContainer implements TriCommand<String, Map<String, Object>> {
    ...
    public void execute(DockerClient client,
        ...
        client.publish(new ContainerTopic(containerId.get(), ContainerEvent.RESTARTED));
